...
2.  **[repx-rs](./crates):** The Execution Layer. A Rust-based runtime (CLI/TUI) that synchronizes the Lab to execution targets (local or SSH/SLURM) and orchestrates job execution.
